...
export default new Map<IconType, ReactElement>([
  [
    "icon",
    <>
      <path d="M289.09 370.909H49.0898V0H70.908C191.41 0 289.09 97.68 289.09 218.182V370.909Z" fill="#FEC514"/><path d="M278.181 599.999H289.09V370.908H49.0898C49.0898 497.432 151.657 599.999 278.181 599.999Z" fill="#343741"/><path d="M343.637 599.999H550.91V370.908H343.637V599.999Z" fill="#00BFB3"/>
    </>,
  ],
  [
    "font",
