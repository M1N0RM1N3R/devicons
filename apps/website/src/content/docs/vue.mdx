...
Some icon names collide with reserved imports from major frameworks. When that happens, the export is suffixed with an underscore: `import { _Vue } from "@dev.icons/vue";`
</Note>
